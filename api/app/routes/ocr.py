...
from app.schemas import OCRPolyOut
...
@router.post("/", response_model=List[OCRPolyOut], status_code=status.HTTP_200_OK, summary="Perform OCR")
async def perform_ocr(file: UploadFile = File(...)):
    ...
    return [
        ...
        OCRPolyOut(polygon=word.geometry, value=word.value, confidence=word.confidence)
